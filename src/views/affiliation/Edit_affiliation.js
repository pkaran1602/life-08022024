...
const Edit_affiliations = (props) => {
  ...
  const { close_fun1, isOpen1, editAffiliation_fun,fileInputRef1, profile_img1, crop1, setCrop1, affiliations_data, img1, updateAvatar1, affiliation_errors1, onImageLoad1, handle_change, handleFile1 } = props
